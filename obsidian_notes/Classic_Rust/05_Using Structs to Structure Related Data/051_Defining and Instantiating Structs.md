...
Because the parameter names and the struct field names are exactly the same in Listing 5-4, we can use the _field init shorthand_ syntax to rewrite `build_user` so that it behaves exactly the same but doesn’t have the repetition of `username` and `email`, as shown in Listing 5-5.
...
> - [[032_Data Types|032 Data Types]] — tuples, the field-less cousin of structs
> - [[031_ Variables and Mutability|031 Variables and Mutability]] — mutability of struct instances
> - [[041_What is ownership|041 What is ownership]] — ownership of struct data
