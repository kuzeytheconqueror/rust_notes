...
```
[Listing 6-1](https://doc.rust-lang.org/stable/book/ch06-01-defining-an-enum.html#listing-6-1): Storing the data and `IpAddrKind` variant of an IP address using a `struct`
...
```
[Listing 6-2](https://doc.rust-lang.org/stable/book/ch06-01-defining-an-enum.html#listing-6-2): A `Message` enum whose variants each store different amounts and types of values
