...
[Listing 6-6](https://doc.rust-lang.org/stable/book/ch06-03-if-let.html#listing-6-6): A `match` that only cares about executing code when the value is `Some`
...
[Listing 6-7](https://doc.rust-lang.org/stable/book/ch06-03-if-let.html#listing-6-7): Checking whether a state existed in 1900 by using conditionals nested inside an `if let`
...
[Listing 6-8](https://doc.rust-lang.org/stable/book/ch06-03-if-let.html#listing-6-8): Using `if let` to produce a value or return early
...
[Listing 6-9](https://doc.rust-lang.org/stable/book/ch06-03-if-let.html#listing-6-9): Using `let...else` to clarify the flow through the function
...
---
> [!info] Source
> Nearly verbatim from [Concise Control Flow with if let and let...else](https://doc.rust-lang.org/stable/book/ch06-03-if-let.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[062B_The Match Control Flow Construct - Continuation|The Match Control Flow Construct - Continuation]] — previous section
> - [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] — next section

---
← [[062B_The Match Control Flow Construct - Continuation|The Match Control Flow Construct - Continuation]] · [[README|⌂ Classic Rust Index]] · [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] →
