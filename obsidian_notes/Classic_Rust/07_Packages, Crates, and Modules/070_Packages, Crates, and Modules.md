...
[workspaces]: https://doc.rust-lang.org/stable/book/ch14-03-cargo-workspaces.html

---
> [!info] Source
> Nearly verbatim from [Packages, Crates, and Modules](https://doc.rust-lang.org/stable/book/ch07-00-managing-growing-projects-with-packages-crates-and-modules.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[063_Concise Control Flow with if let and let...else|Concise Control Flow with if let and let...else]] — previous section
> - [[071_Packages and Crates|Packages and Crates]] — next section

---
← [[063_Concise Control Flow with if let and let...else|Concise Control Flow with if let and let...else]] · [[README|⌂ Classic Rust Index]] · [[071_Packages and Crates|Packages and Crates]] →
