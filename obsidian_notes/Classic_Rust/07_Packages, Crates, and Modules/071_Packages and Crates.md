...
[basics]: https://doc.rust-lang.org/stable/book/ch01-02-hello-world.html#rust-program-basics
...
---
> [!info] Source
> Nearly verbatim from [Packages and Crates](https://doc.rust-lang.org/stable/book/ch07-01-packages-and-crates.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] — previous section
> - [[072_Control Scope and Privacy with Modules|Control Scope and Privacy with Modules]] — next section

---
← [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] · [[README|⌂ Classic Rust Index]] · [[072_Control Scope and Privacy with Modules|Control Scope and Privacy with Modules]] →
