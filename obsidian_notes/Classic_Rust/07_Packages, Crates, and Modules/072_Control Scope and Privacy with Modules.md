...
[Listing 7-1](https://doc.rust-lang.org/stable/book/ch07-02-defining-modules-to-control-scope-and-privacy.html#listing-7-1): A `front_of_house` module containing other modules that then contain functions
...
[Listing 7-2](https://doc.rust-lang.org/stable/book/ch07-02-defining-modules-to-control-scope-and-privacy.html#listing-7-2): The module tree for the code in Listing 7-1
...
---
> [!info] Source
> Nearly verbatim from [Control Scope and Privacy with Modules](https://doc.rust-lang.org/stable/book/ch07-02-defining-modules-to-control-scope-and-privacy.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] — chapter overview
> - [[071_Packages and Crates|Packages and Crates]] — previous section
> - [[073_Paths for Referring to an Item in the Module Tree|Paths for Referring to an Item in the Module Tree]] — next section

---
← [[071_Packages and Crates|Packages and Crates]] · [[README|⌂ Classic Rust Index]] · [[073_Paths for Referring to an Item in the Module Tree|Paths for Referring to an Item in the Module Tree]] →
