...
[Listing 7-3](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-3): Calling the `add_to_waitlist` function using absolute and relative paths
...
[Listing 7-4](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-4): Compiler errors from building the code in Listing 7-3
...
[Listing 7-5](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-5): Declaring the `hosting` module as `pub` to use it from `eat_at_restaurant`
...
[Listing 7-6](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-6): Compiler errors from building the code in Listing 7-5
...
[Listing 7-7](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-7): Adding the `pub` keyword to `mod hosting` and `fn add_to_waitlist` lets us call the function from `eat_at_restaurant`.
...
[Listing 7-8](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-8): Calling a function using a relative path starting with `super`
...
[Listing 7-9](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-9): A struct with some public fields and some private fields
...
[Listing 7-10](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#listing-7-10): Designating an enum as public makes all its variants public.
...
[pub]: https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#exposing-paths-with-the-pub-keyword
[api-guidelines]: https://rust-lang.github.io/api-guidelines/
[ch12]: https://doc.rust-lang.org/stable/book/ch12-00-an-io-project.html

---
> [!info] Source
> Nearly verbatim from [Paths for Referring to an Item in the Module Tree](https://doc.rust-lang.org/stable/book/ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] — chapter overview
> - [[072_Control Scope and Privacy with Modules|Control Scope and Privacy with Modules]] — previous section
> - [[074_Bringing Paths Into Scope with the use Keyword|Bringing Paths Into Scope with the use Keyword]] — next section

---
← [[072_Control Scope and Privacy with Modules|Control Scope and Privacy with Modules]] · [[README|⌂ Classic Rust Index]] · [[074_Bringing Paths Into Scope with the use Keyword|Bringing Paths Into Scope with the use Keyword]] →
