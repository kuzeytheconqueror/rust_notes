...
[Listing 7-21](https://doc.rust-lang.org/stable/book/ch07-05-separating-modules-into-different-files.html#listing-7-21): Declaring the `front_of_house` module whose body will be in *src/front_of_house.rs*
...
[Listing 7-22](https://doc.rust-lang.org/stable/book/ch07-05-separating-modules-into-different-files.html#listing-7-22): Definitions inside the `front_of_house` module in *src/front_of_house.rs*
...
---
> [!info] Source
> Nearly verbatim from [Separating Modules into Different Files](https://doc.rust-lang.org/stable/book/ch07-05-separating-modules-into-different-files.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[070_Packages, Crates, and Modules|Packages, Crates, and Modules]] — chapter overview
> - [[074_Bringing Paths Into Scope with the use Keyword|Bringing Paths Into Scope with the use Keyword]] — previous section
> - [[080_Common Collections|Common Collections]] — next section

---
← [[074_Bringing Paths Into Scope with the use Keyword|Bringing Paths Into Scope with the use Keyword]] · [[README|⌂ Classic Rust Index]] · [[080_Common Collections|Common Collections]] →
