...
[Listing 8-1](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-1): Creating a new, empty vector to hold values of type `i32`
...
[Listing 8-2](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-2): Creating a new vector containing values
...
[Listing 8-3](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-3): Using the `push` method to add values to a vector
...
[Listing 8-4](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-4): Using indexing syntax and using the `get` method to access an item in a vector
...
[Listing 8-5](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-5): Attempting to access the element at index 100 in a vector containing five elements
...
[Listing 8-6](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-6): Attempting to add an element to a vector while holding a reference to an item
...
[Listing 8-7](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-7): Printing each element in a vector by iterating over the elements using a `for` loop
...
[Listing 8-8](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-8): Iterating over mutable references to elements in a vector
...
[Listing 8-9](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-9): Defining an enum to store values of different types in one vector
...
[Listing 8-10](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html#listing-8-10): Showing where the vector and its elements are dropped
...
[deref]: https://doc.rust-lang.org/stable/book/ch15-02-deref.html#following-the-pointer-to-the-value-with-the-dereference-operator

---
> [!info] Source
> Nearly verbatim from [Storing Lists of Values with Vectors](https://doc.rust-lang.org/stable/book/ch08-01-vectors.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[080_Common Collections|Common Collections]] — previous section
> - [[082_Storing UTF-8 Encoded Text with Strings|Storing UTF-8 Encoded Text with Strings]] — next section

---
← [[080_Common Collections|Common Collections]] · [[README|⌂ Classic Rust Index]] · [[082_Storing UTF-8 Encoded Text with Strings|Storing UTF-8 Encoded Text with Strings]] →
