...
[Listing 8-11](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-11): Creating a new, empty `String`
...
[Listing 8-12](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-12): Using the `to_string` method to create a `String` from a string literal
...
[Listing 8-13](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-13): Using the `String::from` function to create a `String` from a string literal
...
[Listing 8-14](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-14): Storing greetings in different languages in strings
...
[Listing 8-15](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-15): Appending a string slice to a `String` using the `push_str` method
...
[Listing 8-16](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-16): Using a string slice after appending its contents to a `String`
...
[Listing 8-17](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-17): Adding one character to a `String` value using `push`
...
[Listing 8-18](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-18): Using the `+` operator to combine two `String` values into a new `String` value
...
[Listing 8-19](https://doc.rust-lang.org/stable/book/ch08-02-strings.html#listing-8-19): Attempting to use indexing syntax with a `String`
...
---
> [!info] Source
> Nearly verbatim from [Storing UTF-8 Encoded Text with Strings](https://doc.rust-lang.org/stable/book/ch08-02-strings.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[080_Common Collections|Common Collections]] — chapter overview
> - [[081_Storing Lists of Values with Vectors|Storing Lists of Values with Vectors]] — previous section
> - [[083_Storing Keys with Associated Values in Hash Maps|Storing Keys with Associated Values in Hash Maps]] — next section

---
← [[081_Storing Lists of Values with Vectors|Storing Lists of Values with Vectors]] · [[README|⌂ Classic Rust Index]] · [[083_Storing Keys with Associated Values in Hash Maps|Storing Keys with Associated Values in Hash Maps]] →
