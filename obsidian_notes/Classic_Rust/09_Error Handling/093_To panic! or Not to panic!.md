...
[Listing 9-13](https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html#listing-9-13): A `Guess` type that will only continue with values between 1 and 100
...
[encoding]: https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#encoding-states-and-behavior-as-types

---
> [!info] Source
> Nearly verbatim from [To panic! or Not to panic!](https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[090_Error Handling|Error Handling]] — chapter overview
> - [[092_Recoverable Errors with Result|Recoverable Errors with Result]] — previous section
> - [[100_Generic Types, Traits, and Lifetimes|Generic Types, Traits, and Lifetimes]] — next section

---
← [[092_Recoverable Errors with Result|Recoverable Errors with Result]] · [[README|⌂ Classic Rust Index]] · [[100_Generic Types, Traits, and Lifetimes|Generic Types, Traits, and Lifetimes]] →
