...
[Listing 10-12](https://doc.rust-lang.org/stable/book/ch10-02-traits.html#listing-10-12): A `Summary` trait that consists of the behavior provided by a `summarize` method
...
[Listing 10-13](https://doc.rust-lang.org/stable/book/ch10-02-traits.html#listing-10-13): Implementing the `Summary` trait on the `NewsArticle` and `SocialPost` types
...
[Listing 10-14](https://doc.rust-lang.org/stable/book/ch10-02-traits.html#listing-10-14): Defining a `Summary` trait with a default implementation of the `summarize` method
...
[Listing 10-15](https://doc.rust-lang.org/stable/book/ch10-02-traits.html#listing-10-15): Conditionally implementing methods on a generic type depending on trait bounds
...
[methods]: https://doc.rust-lang.org/stable/book/ch05-03-method-syntax.html#method-syntax

---
> [!info] Source
> Nearly verbatim from [Defining Shared Behavior with Traits](https://doc.rust-lang.org/stable/book/ch10-02-traits.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[100_Generic Types, Traits, and Lifetimes|Generic Types, Traits, and Lifetimes]] — chapter overview
> - [[101_Generic Data Types|Generic Data Types]] — previous section
> - [[103_Validating References with Lifetimes|Validating References with Lifetimes]] — next section

---
← [[101_Generic Data Types|Generic Data Types]] · [[README|⌂ Classic Rust Index]] · [[103_Validating References with Lifetimes|Validating References with Lifetimes]] →
