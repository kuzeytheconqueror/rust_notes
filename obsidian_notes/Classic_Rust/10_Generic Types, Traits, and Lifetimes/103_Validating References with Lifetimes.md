...
[Listing 10-16](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-16): An attempt to use a reference whose value has gone out of scope
...
[Listing 10-17](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-17): Annotations of the lifetimes of `r` and `x`, named `'a` and `'b`, respectively
...
[Listing 10-18](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-18): A valid reference because the data has a longer lifetime than the reference
...
[Listing 10-19](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-19): A `main` function that calls the `longest` function to find the longer of two string slices
...
[Listing 10-20](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-20): An implementation of the `longest` function that returns the longer of two string slices but does not yet compile
...
[Listing 10-21](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-21): The `longest` function definition specifying that all the references in the signature must have the same lifetime `'a`
...
[Listing 10-22](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-22): Using the `longest` function with references to `String` values that have different concrete lifetimes
...
[Listing 10-23](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-23): Attempting to use `result` after `string2` has gone out of scope
...
[Listing 10-24](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-24): A struct that holds a reference, requiring a lifetime annotation
...
[Listing 10-25](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html#listing-10-25): A function we defined in Listing 4-9 that compiled without lifetime annotations, even though the parameter and return type are references
...
[references-and-borrowing]: https://doc.rust-lang.org/stable/book/ch04-02-references-and-borrowing.html#references-and-borrowing
...
---
> [!info] Source
> Nearly verbatim from [Validating References with Lifetimes](https://doc.rust-lang.org/stable/book/ch10-03-lifetime-syntax.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[100_Generic Types, Traits, and Lifetimes|Generic Types, Traits, and Lifetimes]] — chapter overview
> - [[102_Defining Shared Behavior with Traits|Defining Shared Behavior with Traits]] — previous section
> - [[110_Writing Automated Tests|Writing Automated Tests]] — next section

---
← [[102_Defining Shared Behavior with Traits|Defining Shared Behavior with Traits]] · [[README|⌂ Classic Rust Index]] · [[110_Writing Automated Tests|Writing Automated Tests]] →
