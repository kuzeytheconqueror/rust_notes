...
[Listing 12-5](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-5): Extracting a `parse_config` function from `main`
...
[Listing 12-6](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-6): Refactoring `parse_config` to return an instance of a `Config` struct
...
[Listing 12-7](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-7): Changing `parse_config` into `Config::new`
...
[Listing 12-8](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-8): Adding a check for the number of arguments
...
[Listing 12-9](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-9): Returning a `Result` from `Config::build`
...
[Listing 12-10](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-10): Exiting with an error code if building a `Config` fails
...
Projects”](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#separation-of-concerns-for-binary-projects), we’ll
...
[Listing 12-11](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-11): Extracting a `run` function containing the rest of the program logic
...
[Listing 12-12](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-12): Changing the `run` function to return `Result`
...
[Listing 12-13](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-13): Defining the `search` function in *src/lib.rs*
...
[Listing 12-14](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html#listing-12-14): Using the `minigrep` library crate’s `search` function in *src/main.rs*
...
[ch13]: https://doc.rust-lang.org/stable/book/ch13-00-functional-features.html
[ch9-custom-types]: https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html#creating-custom-types-for-validation
[ch9-error-guidelines]: https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html#guidelines-for-error-handling
[ch9-result]: https://doc.rust-lang.org/stable/book/ch09-02-recoverable-errors-with-result.html
[ch18]: https://doc.rust-lang.org/stable/book/ch18-00-oop.html
[ch9-question-mark]: https://doc.rust-lang.org/stable/book/ch09-02-recoverable-errors-with-result.html#a-shortcut-for-propagating-errors-the--operator

---
> [!info] Source
> Nearly verbatim from [Refactoring to Improve Modularity and Error Handling](https://doc.rust-lang.org/stable/book/ch12-03-improving-error-handling-and-modularity.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[120_An I and O Project - Building a Command Line Program|An I/O Project: Building a Command Line Program]] — chapter overview
> - [[122_Reading a File|Reading a File]] — previous section
> - [[124_Adding Functionality with Test Driven Development|Adding Functionality with Test Driven Development]] — next section

---
← [[122_Reading a File|Reading a File]] · [[README|⌂ Classic Rust Index]] · [[124_Adding Functionality with Test Driven Development|Adding Functionality with Test Driven Development]] →
