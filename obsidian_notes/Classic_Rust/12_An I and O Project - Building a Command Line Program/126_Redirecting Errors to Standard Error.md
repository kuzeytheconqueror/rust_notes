...
[Listing 12-24](https://doc.rust-lang.org/stable/book/ch12-06-writing-to-stderr-instead-of-stdout.html#listing-12-24): Writing error messages to standard error instead of standard output using `eprintln!`
...
---
> [!info] Source
> Nearly verbatim from [Redirecting Errors to Standard Error](https://doc.rust-lang.org/stable/book/ch12-06-writing-to-stderr-instead-of-stdout.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[120_An I and O Project - Building a Command Line Program|An I/O Project: Building a Command Line Program]] — chapter overview
> - [[125_Working with Environment Variables|Working with Environment Variables]] — previous section
> - [[130_Functional Language Features - Iterators and Closures|Functional Language Features: Iterators and Closures]] — next section

---
← [[125_Working with Environment Variables|Working with Environment Variables]] · [[README|⌂ Classic Rust Index]] · [[130_Functional Language Features - Iterators and Closures|Functional Language Features: Iterators and Closures]] →
