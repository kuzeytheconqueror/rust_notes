...
[Listing 13-1](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-1): Shirt company giveaway situation
...
[Listing 13-2](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-2): Adding optional type annotations of the parameter and return value types in the closure
...
[Listing 13-3](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-3): Attempting to call a closure whose types are inferred with two different types
...
[Listing 13-4](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-4): Defining and calling a closure that captures an immutable reference
...
[Listing 13-5](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-5): Defining and calling a closure that captures a mutable reference
...
[Listing 13-6](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-6): Using `move` to force the closure for the thread to take ownership of `list`
...
[Listing 13-7](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-7): Using `sort_by_key` to order rectangles by width
...
[Listing 13-8](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-8): Attempting to use an `FnOnce` closure with `sort_by_key`
...
[Listing 13-9](https://doc.rust-lang.org/stable/book/ch13-01-closures.html#listing-13-9): Using an `FnMut` closure with `sort_by_key` is allowed.
...
---
> [!info] Source
> Nearly verbatim from [Closures](https://doc.rust-lang.org/stable/book/ch13-01-closures.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[130_Functional Language Features - Iterators and Closures|Functional Language Features: Iterators and Closures]] — previous section
> - [[132_Processing a Series of Items with Iterators|Processing a Series of Items with Iterators]] — next section

---
← [[130_Functional Language Features - Iterators and Closures|Functional Language Features: Iterators and Closures]] · [[README|⌂ Classic Rust Index]] · [[132_Processing a Series of Items with Iterators|Processing a Series of Items with Iterators]] →
