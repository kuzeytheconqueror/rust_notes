...
[Listing 13-10](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-10): Creating an iterator
...
[Listing 13-11](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-11): Using an iterator in a `for` loop
...
[Listing 13-12](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-12): Calling the `next` method on an iterator
...
[Listing 13-13](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-13): Calling the `sum` method to get the total of all items in the iterator
...
[Listing 13-14](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-14): Calling the iterator adapter `map` to create a new iterator
...
[Listing 13-15](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-15): Calling the `map` method to create a new iterator, and then calling the `collect` method to consume the new iterator and create a vector
...
[Listing 13-16](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html#listing-13-16): Using the `filter` method with a closure that captures `shoe_size`
...
---
> [!info] Source
> Nearly verbatim from [Processing a Series of Items with Iterators](https://doc.rust-lang.org/stable/book/ch13-02-iterators.html) in *The Rust Programming Language*.
...
> - [[131_Closures|Closures]] — previous section
> - [[133_Improving Our I and O Project|Improving Our I/O Project]] — next section

---
← [[131_Closures|Closures]] · [[README|⌂ Classic Rust Index]] · [[133_Improving Our I and O Project|Improving Our I/O Project]] →
