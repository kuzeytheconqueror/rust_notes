...
---
> [!info] Source
> Nearly verbatim from [Smart Pointers](https://doc.rust-lang.org/stable/book/ch15-00-smart-pointers.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[145_Extending Cargo with Custom Commands|Extending Cargo with Custom Commands]] — previous section
> - [[151_Using Box(T) to Point to Data on the Heap|Using Box<T> to Point to Data on the Heap]] — next section

---
← [[145_Extending Cargo with Custom Commands|Extending Cargo with Custom Commands]] · [[README|⌂ Classic Rust Index]] · [[151_Using Box(T) to Point to Data on the Heap|Using Box<T> to Point to Data on the Heap]] →
