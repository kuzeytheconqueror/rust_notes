...
[Listing 15-6](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-6): Using the dereference operator to follow a reference to an `i32` value
...
[Listing 15-7](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-7): Using the dereference operator on a `Box<i32>`
...
[Listing 15-8](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-8): Defining a `MyBox<T>` type
...
[Listing 15-9](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-9): Attempting to use `MyBox<T>` in the same way we used references and `Box<T>`
...
[Listing 15-10](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-10): Implementing `Deref` on `MyBox<T>`
...
[Listing 15-11](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-11): A `hello` function that has the parameter `name` of type `&str`
...
[Listing 15-12](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-12): Calling `hello` with a reference to a `MyBox<String>` value, which works because of deref coercion
...
[Listing 15-13](https://doc.rust-lang.org/stable/book/ch15-02-deref.html#listing-15-13): The code we would have to write if Rust didn’t have deref coercion
...
[impl-trait]: https://doc.rust-lang.org/stable/book/ch10-02-traits.html#implementing-a-trait-on-a-type
...
---
> [!info] Source
> Nearly verbatim from [Treating Smart Pointers Like Regular References](https://doc.rust-lang.org/stable/book/ch15-02-deref.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[150_Smart Pointers|Smart Pointers]] — chapter overview
> - [[151_Using Box(T) to Point to Data on the Heap|Using Box<T> to Point to Data on the Heap]] — previous section
> - [[153_Running Code on Cleanup with the Drop Trait|Running Code on Cleanup with the Drop Trait]] — next section

---
← [[151_Using Box(T) to Point to Data on the Heap|Using Box<T> to Point to Data on the Heap]] · [[README|⌂ Classic Rust Index]] · [[153_Running Code on Cleanup with the Drop Trait|Running Code on Cleanup with the Drop Trait]] →
