...
[Listing 15-14](https://doc.rust-lang.org/stable/book/ch15-03-drop.html#listing-15-14): A `CustomSmartPointer` struct that implements the `Drop` trait where we would put our cleanup code
...
[Listing 15-15](https://doc.rust-lang.org/stable/book/ch15-03-drop.html#listing-15-15): Attempting to call the `drop` method from the `Drop` trait manually to clean up early
...
[Listing 15-16](https://doc.rust-lang.org/stable/book/ch15-03-drop.html#listing-15-16): Calling `std::mem::drop` to explicitly drop a value before it goes out of scope
...
---
> [!info] Source
> Nearly verbatim from [Running Code on Cleanup with the Drop Trait](https://doc.rust-lang.org/stable/book/ch15-03-drop.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[150_Smart Pointers|Smart Pointers]] — chapter overview
> - [[152_Treating Smart Pointers Like Regular References|Treating Smart Pointers Like Regular References]] — previous section
> - [[154_Rc(T), the Reference Counted Smart Pointer|Rc<T>, the Reference Counted Smart Pointer]] — next section

---
← [[152_Treating Smart Pointers Like Regular References|Treating Smart Pointers Like Regular References]] · [[README|⌂ Classic Rust Index]] · [[154_Rc(T), the Reference Counted Smart Pointer|Rc<T>, the Reference Counted Smart Pointer]] →
