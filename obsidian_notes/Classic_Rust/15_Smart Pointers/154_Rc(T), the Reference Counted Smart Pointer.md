...
at the tails of lists 'b' and 'c' are both list 'a'.](../images_inside_notes/rust_book/trpl15-03.svg)
...
[Listing 15-17](https://doc.rust-lang.org/stable/book/ch15-04-rc.html#listing-15-17): Demonstrating that we’re not allowed to have two lists using `Box<T>` that try to share ownership of a third list
...
[Listing 15-18](https://doc.rust-lang.org/stable/book/ch15-04-rc.html#listing-15-18): A definition of `List` that uses `Rc<T>`
...
[Listing 15-19](https://doc.rust-lang.org/stable/book/ch15-04-rc.html#listing-15-19): Printing the reference count
...
[preventing-ref-cycles]: https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#preventing-reference-cycles-turning-an-rct-into-a-weakt

---
> [!info] Source
> Nearly verbatim from [Rc<T>, the Reference Counted Smart Pointer](https://doc.rust-lang.org/stable/book/ch15-04-rc.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[150_Smart Pointers|Smart Pointers]] — chapter overview
> - [[153_Running Code on Cleanup with the Drop Trait|Running Code on Cleanup with the Drop Trait]] — previous section
> - [[155_RefCell(T) and the Interior Mutability Pattern|RefCell<T> and the Interior Mutability Pattern]] — next section

---
← [[153_Running Code on Cleanup with the Drop Trait|Running Code on Cleanup with the Drop Trait]] · [[README|⌂ Classic Rust Index]] · [[155_RefCell(T) and the Interior Mutability Pattern|RefCell<T> and the Interior Mutability Pattern]] →
