...
[Listing 15-20](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html#listing-15-20): A library to keep track of how close a value is to a maximum value and warn when the value is at certain levels
...
[Listing 15-21](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html#listing-15-21): An attempt to implement a `MockMessenger` that isn’t allowed by the borrow checker
...
[Listing 15-22](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html#listing-15-22): Using `RefCell<T>` to mutate an inner value while the outer value is considered immutable
...
[Listing 15-23](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html#listing-15-23): Creating two mutable references in the same scope to see that `RefCell<T>` will panic
...
[Listing 15-24](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html#listing-15-24): Using `Rc<RefCell<i32>>` to create a `List` that we can mutate
...
[wheres-the---operator]: https://doc.rust-lang.org/stable/book/ch05-03-method-syntax.html#wheres-the---operator

---
> [!info] Source
> Nearly verbatim from [RefCell<T> and the Interior Mutability Pattern](https://doc.rust-lang.org/stable/book/ch15-05-interior-mutability.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[150_Smart Pointers|Smart Pointers]] — chapter overview
> - [[154_Rc(T), the Reference Counted Smart Pointer|Rc<T>, the Reference Counted Smart Pointer]] — previous section
> - [[156_Reference Cycles Can Leak Memory|Reference Cycles Can Leak Memory]] — next section

---
← [[154_Rc(T), the Reference Counted Smart Pointer|Rc<T>, the Reference Counted Smart Pointer]] · [[README|⌂ Classic Rust Index]] · [[156_Reference Cycles Can Leak Memory|Reference Cycles Can Leak Memory]] →
