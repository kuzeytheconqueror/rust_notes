...
[Listing 15-25](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#listing-15-25): A cons list definition that holds a `RefCell<T>` so that we can modify what a `Cons` variant is referring to
...
[Listing 15-26](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#listing-15-26): Creating a reference cycle of two `List` values pointing to each other
...
![A rectangle labeled 'a' that points to a rectangle containing the integer 5. A rectangle labeled 'b' that points to a rectangle containing the integer 10. The rectangle containing 5 points to the rectangle containing 10, and the rectangle containing 10 points back to the rectangle containing 5, creating a cycle.](../images_inside_notes/rust_book/trpl15-04.svg)
...
[Listing 15-27](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#listing-15-27): Creating a `leaf` node with no children and a `branch` node with `leaf` as one of its children
...
[Listing 15-28](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#listing-15-28): A `leaf` node with a weak reference to its parent node, `branch`
...
[Listing 15-29](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html#listing-15-29): Creating `branch` in an inner scope and examining strong and weak reference counts
...
---
> [!info] Source
> Nearly verbatim from [Reference Cycles Can Leak Memory](https://doc.rust-lang.org/stable/book/ch15-06-reference-cycles.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[150_Smart Pointers|Smart Pointers]] — chapter overview
> - [[155_RefCell(T) and the Interior Mutability Pattern|RefCell<T> and the Interior Mutability Pattern]] — previous section
> - [[160_Fearless Concurrency|Fearless Concurrency]] — next section

---
← [[155_RefCell(T) and the Interior Mutability Pattern|RefCell<T> and the Interior Mutability Pattern]] · [[README|⌂ Classic Rust Index]] · [[160_Fearless Concurrency|Fearless Concurrency]] →
