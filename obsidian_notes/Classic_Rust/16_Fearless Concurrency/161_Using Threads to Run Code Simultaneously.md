...
[Listing 16-1](https://doc.rust-lang.org/stable/book/ch16-01-threads.html#listing-16-1): Creating a new thread to print one thing while the main thread prints something else
...
[Listing 16-2](https://doc.rust-lang.org/stable/book/ch16-01-threads.html#listing-16-2): Saving a `JoinHandle<T>` from `thread::spawn` to guarantee the thread is run to completion
...
[Listing 16-3](https://doc.rust-lang.org/stable/book/ch16-01-threads.html#listing-16-3): Attempting to use a vector created by the main thread in another thread
...
[Listing 16-4](https://doc.rust-lang.org/stable/book/ch16-01-threads.html#listing-16-4): A thread with a closure that attempts to capture a reference to `v` from a main thread that drops `v`
...
[Listing 16-5](https://doc.rust-lang.org/stable/book/ch16-01-threads.html#listing-16-5): Using the `move` keyword to force a closure to take ownership of the values it uses
...
[capture]: https://doc.rust-lang.org/stable/book/ch13-01-closures.html#capturing-references-or-moving-ownership

---
> [!info] Source
> Nearly verbatim from [Using Threads to Run Code Simultaneously](https://doc.rust-lang.org/stable/book/ch16-01-threads.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[160_Fearless Concurrency|Fearless Concurrency]] — previous section
> - [[162_Transfer Data Between Threads with Message Passing|Transfer Data Between Threads with Message Passing]] — next section

---
← [[160_Fearless Concurrency|Fearless Concurrency]] · [[README|⌂ Classic Rust Index]] · [[162_Transfer Data Between Threads with Message Passing|Transfer Data Between Threads with Message Passing]] →
