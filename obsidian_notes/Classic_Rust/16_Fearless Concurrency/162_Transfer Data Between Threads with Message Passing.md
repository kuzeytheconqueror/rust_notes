...
[Listing 16-6](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-6): Creating a channel and assigning the two halves to `tx` and `rx`
...
[Listing 16-7](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-7)
...
[Listing 16-8](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-8)
...
[Listing 16-9](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-9): Attempting to use `val` after we’ve sent it down the channel
...
[Listing 16-10](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-10): Sending multiple messages and pausing between each one
...
[Listing 16-11](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html#listing-16-11): Sending multiple messages from multiple producers
...
---
> [!info] Source
> Nearly verbatim from [Transfer Data Between Threads with Message Passing](https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[160_Fearless Concurrency|Fearless Concurrency]] — chapter overview
> - [[161_Using Threads to Run Code Simultaneously|Using Threads to Run Code Simultaneously]] — previous section
> - [[163_Shared-State Concurrency|Shared-State Concurrency]] — next section

---
← [[161_Using Threads to Run Code Simultaneously|Using Threads to Run Code Simultaneously]] · [[README|⌂ Classic Rust Index]] · [[163_Shared-State Concurrency|Shared-State Concurrency]] →
