...
[Listing 16-12](https://doc.rust-lang.org/stable/book/ch16-03-shared-state.html#listing-16-12): Exploring the API of `Mutex<T>` in a single-threaded context for simplicity
...
[Listing 16-13](https://doc.rust-lang.org/stable/book/ch16-03-shared-state.html#listing-16-13): Ten threads, each incrementing a counter guarded by a `Mutex<T>`
...
[Listing 16-14](https://doc.rust-lang.org/stable/book/ch16-03-shared-state.html#listing-16-14): Attempting to use `Rc<T>` to allow multiple threads to own the `Mutex<T>`
...
[Listing 16-15](https://doc.rust-lang.org/stable/book/ch16-03-shared-state.html#listing-16-15): Using an `Arc<T>` to wrap the `Mutex<T>` to be able to share ownership across multiple threads
...
---
> [!info] Source
> Nearly verbatim from [Shared-State Concurrency](https://doc.rust-lang.org/stable/book/ch16-03-shared-state.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[160_Fearless Concurrency|Fearless Concurrency]] — chapter overview
> - [[162_Transfer Data Between Threads with Message Passing|Transfer Data Between Threads with Message Passing]] — previous section
> - [[164_Extensible Concurrency with Send and Sync|Extensible Concurrency with Send and Sync]] — next section

---
← [[162_Transfer Data Between Threads with Message Passing|Transfer Data Between Threads with Message Passing]] · [[README|⌂ Classic Rust Index]] · [[164_Extensible Concurrency with Send and Sync|Extensible Concurrency with Send and Sync]] →
