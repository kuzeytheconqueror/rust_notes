...
---
> [!info] Source
> Nearly verbatim from [Extensible Concurrency with Send and Sync](https://doc.rust-lang.org/stable/book/ch16-04-extensible-concurrency-sync-and-send.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[160_Fearless Concurrency|Fearless Concurrency]] — chapter overview
> - [[163_Shared-State Concurrency|Shared-State Concurrency]] — previous section
> - [[170_Fundamentals of Asynchronous Programming - Async, Await, Futures, and Streams|Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams]] — next section

---
← [[163_Shared-State Concurrency|Shared-State Concurrency]] · [[README|⌂ Classic Rust Index]] · [[170_Fundamentals of Asynchronous Programming - Async, Await, Futures, and Streams|Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams]] →
