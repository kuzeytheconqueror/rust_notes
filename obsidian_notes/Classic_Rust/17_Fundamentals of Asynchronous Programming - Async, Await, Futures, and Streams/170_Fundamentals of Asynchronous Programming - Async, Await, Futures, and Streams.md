...
![A diagram with stacked boxes labeled Task A and Task B, with diamonds in them representing subtasks. Arrows point from A1 to B1, B1 to A2, A2 to B2, B2 to A3, A3 to A4, and A4 to B3. The arrows between the subtasks cross the boxes between Task A and Task B.](../images_inside_notes/rust_book/trpl17-01.svg)
...
![A diagram with stacked boxes labeled Task A and Task B, with diamonds in them representing subtasks. Arrows point from A1 to A2, A2 to A3, A3 to A4, B1 to B2, and B2 to B3. No arrows cross between the boxes for Task A and Task B.](../images_inside_notes/rust_book/trpl17-02.svg)
...
---
> [!info] Source
> Nearly verbatim from [Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams](https://doc.rust-lang.org/stable/book/ch17-00-async-await.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[164_Extensible Concurrency with Send and Sync|Extensible Concurrency with Send and Sync]] — previous section
> - [[171_Futures and the Async Syntax|Futures and the Async Syntax]] — next section

---
← [[164_Extensible Concurrency with Send and Sync|Extensible Concurrency with Send and Sync]] · [[README|⌂ Classic Rust Index]] · [[171_Futures and the Async Syntax|Futures and the Async Syntax]] →
