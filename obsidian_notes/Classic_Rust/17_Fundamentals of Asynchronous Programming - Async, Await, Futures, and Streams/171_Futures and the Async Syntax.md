...
[Listing 17-1](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#listing-17-1): Defining an async function to get the title element from an HTML page
...
[Listing 17-2](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#listing-17-2): Chaining with the `await` keyword
...
[Listing 17-3](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#listing-17-3): Calling the `page_title` function from `main` with a user-supplied argument
...
[Listing 17-4](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#listing-17-4): Awaiting an async block with `trpl::block_on`
...
[Listing 17-5](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#listing-17-5): Calling `page_title` for two URLs to see which returns first
...
[impl-trait]: https://doc.rust-lang.org/stable/book/ch10-02-traits.html#traits-as-parameters
[iterators-lazy]: https://doc.rust-lang.org/stable/book/ch13-02-iterators.html
[thread-spawn]: https://doc.rust-lang.org/stable/book/ch16-01-threads.html#creating-a-new-thread-with-spawn
[cli-args]: https://doc.rust-lang.org/stable/book/ch12-01-accepting-command-line-arguments.html
...
---
> [!info] Source
> Nearly verbatim from [Futures and the Async Syntax](https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[170_Fundamentals of Asynchronous Programming - Async, Await, Futures, and Streams|Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams]] — previous section
> - [[172_Applying Concurrency with Async|Applying Concurrency with Async]] — next section

---
← [[170_Fundamentals of Asynchronous Programming - Async, Await, Futures, and Streams|Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams]] · [[README|⌂ Classic Rust Index]] · [[172_Applying Concurrency with Async|Applying Concurrency with Async]] →
