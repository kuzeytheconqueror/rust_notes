...
[Listing 17-6](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-6): Creating a new task to print one thing while the main task prints something else
...
[Listing 17-7](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-7): Using `await` with a join handle to run a task to completion
...
[Listing 17-8](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-8): Using `trpl::join` to await two anonymous futures
...
[Listing 17-9](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-9): Creating an async channel and assigning the two halves to `tx` and `rx`
...
[Listing 17-10](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-10): Sending and receiving multiple messages over the async channel and sleeping with an `await` between each message
...
[Listing 17-11](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-11): Separating `send` and `recv` into their own `async` blocks and awaiting the futures for those blocks
...
[Listing 17-12](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-12): A revision of the code from Listing 17-11 that correctly shuts down when complete
...
[Listing 17-13](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html#listing-17-13): Using multiple producers with async blocks
...
[thread-spawn]: https://doc.rust-lang.org/stable/book/ch16-01-threads.html#creating-a-new-thread-with-spawn
[join-handles]: https://doc.rust-lang.org/stable/book/ch16-01-threads.html#waiting-for-all-threads-to-finish
[message-passing-threads]: https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html
[if-let]: https://doc.rust-lang.org/stable/book/ch06-03-if-let.html
[capture-or-move]: https://doc.rust-lang.org/stable/book/ch13-01-closures.html#capturing-references-or-moving-ownership
[move-threads]: https://doc.rust-lang.org/stable/book/ch16-01-threads.html#using-move-closures-with-threads

---
> [!info] Source
> Nearly verbatim from [Applying Concurrency with Async](https://doc.rust-lang.org/stable/book/ch17-02-concurrency-with-async.html) in *The Rust Programming Language*.
...
> - [[171_Futures and the Async Syntax|Futures and the Async Syntax]] — previous section
> - [[173_Working With Any Number of Futures|Working With Any Number of Futures]] — next section

---
← [[171_Futures and the Async Syntax|Futures and the Async Syntax]] · [[README|⌂ Classic Rust Index]] · [[173_Working With Any Number of Futures|Working With Any Number of Futures]] →
