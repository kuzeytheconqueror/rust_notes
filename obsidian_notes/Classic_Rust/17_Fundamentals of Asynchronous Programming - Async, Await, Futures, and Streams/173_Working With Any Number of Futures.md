...
[Listing 17-14](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-14): Using `thread::sleep` to simulate slow operations
...
[Listing 17-15](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-15): Calling the `slow` function to simulate slow operations
...
[Listing 17-16](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-16): Using `trpl::sleep` to let operations switch off making progress
...
[Listing 17-17](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-17): Using `yield_now` to let operations switch off making progress
...
[Listing 17-18](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-18): Using our imagined `timeout` to run a slow operation with a time limit
...
[Listing 17-19](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-19): Defining the signature of `timeout`
...
[Listing 17-20](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#listing-17-20): Defining `timeout` with `select` and `sleep`
...
[async-program]: https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#our-first-async-program

---
> [!info] Source
> Nearly verbatim from [Working With Any Number of Futures](https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html) in *The Rust Programming Language*.
...
> - [[172_Applying Concurrency with Async|Applying Concurrency with Async]] — previous section
> - [[174_Streams - Futures in Sequence|Streams: Futures in Sequence]] — next section

---
← [[172_Applying Concurrency with Async|Applying Concurrency with Async]] · [[README|⌂ Classic Rust Index]] · [[174_Streams - Futures in Sequence|Streams: Futures in Sequence]] →
