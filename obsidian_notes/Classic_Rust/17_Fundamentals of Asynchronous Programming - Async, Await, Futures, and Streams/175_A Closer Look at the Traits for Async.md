...
[Listing 17-23](https://doc.rust-lang.org/stable/book/ch17-05-traits-for-async.html#listing-17-23): Awaiting futures in a collection
...
![A single-column, three-row table representing a future, fut1, which has data values 0 and 1 in the first two rows and an arrow pointing from the third row back to the second row, representing an internal reference within the future.](../images_inside_notes/rust_book/trpl17-04.svg)
...
![Two tables, depicting two futures, fut1 and fut2, each of which has one column and three rows, representing the result of having moved a future out of fut1 into fut2. The first, fut1, is grayed out, with a question mark in each index, representing unknown memory. The second, fut2, has 0 and 1 in the first and second rows and an arrow pointing from its third row back to the second row of fut1, representing a pointer that is referencing the old location in memory of the future before it was moved.](../images_inside_notes/rust_book/trpl17-05.svg)
...
[Listing 17-24](https://doc.rust-lang.org/stable/book/ch17-05-traits-for-async.html#listing-17-24): Pinning the futures to enable moving them into the vector
...
[ch-18]: https://doc.rust-lang.org/stable/book/ch18-00-oop.html
[async-book]: https://rust-lang.github.io/async-book/
[under-the-hood]: https://rust-lang.github.io/async-book/02_execution/01_chapter.html
[pinning]: https://rust-lang.github.io/async-book/04_pinning/01_chapter.html
[first-async]: https://doc.rust-lang.org/stable/book/ch17-01-futures-and-syntax.html#our-first-async-program
[any-number-futures]: https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html#working-with-any-number-of-futures
[streams]: https://doc.rust-lang.org/stable/book/ch17-04-streams.html

---
> [!info] Source
> Nearly verbatim from [A Closer Look at the Traits for Async](https://doc.rust-lang.org/stable/book/ch17-05-traits-for-async.html) in *The Rust Programming Language*.
...
> - [[174_Streams - Futures in Sequence|Streams: Futures in Sequence]] — previous section
> - [[176_Futures, Tasks, and Threads|Futures, Tasks, and Threads]] — next section

---
← [[174_Streams - Futures in Sequence|Streams: Futures in Sequence]] · [[README|⌂ Classic Rust Index]] · [[176_Futures, Tasks, and Threads|Futures, Tasks, and Threads]] →
