...
[Listing 18-1](https://doc.rust-lang.org/stable/book/ch18-01-what-is-oo.html#listing-18-1): An `AveragedCollection` struct that maintains a list of integers and the average of the items in the collection
...
[Listing 18-2](https://doc.rust-lang.org/stable/book/ch18-01-what-is-oo.html#listing-18-2): Implementations of the public methods `add`, `remove`, and `average` on `AveragedCollection`
...
---
> [!info] Source
> Nearly verbatim from [Characteristics of Object-Oriented Languages](https://doc.rust-lang.org/stable/book/ch18-01-what-is-oo.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[180_Object Oriented Programming Features|Object Oriented Programming Features]] — previous section
> - [[182_Using Trait Objects to Abstract over Shared Behavior|Using Trait Objects to Abstract over Shared Behavior]] — next section

---
← [[180_Object Oriented Programming Features|Object Oriented Programming Features]] · [[README|⌂ Classic Rust Index]] · [[182_Using Trait Objects to Abstract over Shared Behavior|Using Trait Objects to Abstract over Shared Behavior]] →
