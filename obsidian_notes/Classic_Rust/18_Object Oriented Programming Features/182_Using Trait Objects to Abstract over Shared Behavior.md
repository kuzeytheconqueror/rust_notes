...
[Listing 18-3](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-3): Definition of the `Draw` trait
...
[Listing 18-4](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-4): Definition of the `Screen` struct with a `components` field holding a vector of trait objects that implement the `Draw` trait
...
[Listing 18-5](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-5): A `run` method on `Screen` that calls the `draw` method on each component
...
[Listing 18-6](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-6): An alternate implementation of the `Screen` struct and its `run` method using generics and trait bounds
...
[Listing 18-7](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-7): A `Button` struct that implements the `Draw` trait
...
[Listing 18-8](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-8): Another crate using `gui` and implementing the `Draw` trait on a `SelectBox` struct
...
[Listing 18-9](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-9): Using trait objects to store values of different types that implement the same trait
...
[Listing 18-10](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html#listing-18-10): Attempting to use a type that doesn’t implement the trait object’s trait
...
[performance-of-code-using-generics]: https://doc.rust-lang.org/stable/book/ch10-01-syntax.html#performance-of-code-using-generics
[dynamically-sized]: https://doc.rust-lang.org/stable/book/ch20-03-advanced-types.html#dynamically-sized-types-and-the-sized-trait
[dyn-compatibility]: https://doc.rust-lang.org/reference/items/traits.html#dyn-compatibility

---
> [!info] Source
> Nearly verbatim from [Using Trait Objects to Abstract over Shared Behavior](https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[180_Object Oriented Programming Features|Object Oriented Programming Features]] — chapter overview
> - [[181_Characteristics of Object-Oriented Languages|Characteristics of Object-Oriented Languages]] — previous section
> - [[183_Implementing an Object-Oriented Design Pattern|Implementing an Object-Oriented Design Pattern]] — next section

---
← [[181_Characteristics of Object-Oriented Languages|Characteristics of Object-Oriented Languages]] · [[README|⌂ Classic Rust Index]] · [[183_Implementing an Object-Oriented Design Pattern|Implementing an Object-Oriented Design Pattern]] →
