...
[Listing 18-11](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-11): Code that demonstrates the desired behavior we want our `blog` crate to have
...
[Listing 18-12](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-12): Definition of a `Post` struct and a `new` function that creates a new `Post` instance, a `State` trait, and a `Draft` struct
...
[Listing 18-13](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-13): Implementing the `add_text` method to add text to a post’s `content`
...
[Listing 18-14](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-14): Adding a placeholder implementation for the `content` method on `Post` that always returns an empty string slice
...
[Listing 18-15](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-15): Implementing `request_review` methods on `Post` and the `State` trait
...
[Listing 18-16](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-16): Implementing the `approve` method on `Post` and the `State` trait
...
[Listing 18-17](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-17): Updating the `content` method on `Post` to delegate to a `content` method on `State`
...
[Listing 18-18](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-18): Adding the `content` method to the `State` trait
...
[Listing 18-19](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-19): A `Post` with a `content` method and a `DraftPost` without a `content` method
...
[Listing 18-20](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-20): A `PendingReviewPost` that gets created by calling `request_review` on `DraftPost` and an `approve` method that turns a `PendingReviewPost` into a published `Post`
...
[Listing 18-21](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#listing-18-21): Modifications to `main` to use the new implementation of the blog post workflow
...
[more-info-than-rustc]: https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html#cases-in-which-you-have-more-information-than-the-compiler
[macros]: https://doc.rust-lang.org/stable/book/ch20-05-macros.html#macros

---
> [!info] Source
> Nearly verbatim from [Implementing an Object-Oriented Design Pattern](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[180_Object Oriented Programming Features|Object Oriented Programming Features]] — chapter overview
> - [[182_Using Trait Objects to Abstract over Shared Behavior|Using Trait Objects to Abstract over Shared Behavior]] — previous section
> - [[190_Patterns and Matching|Patterns and Matching]] — next section

---
← [[182_Using Trait Objects to Abstract over Shared Behavior|Using Trait Objects to Abstract over Shared Behavior]] · [[README|⌂ Classic Rust Index]] · [[190_Patterns and Matching|Patterns and Matching]] →
