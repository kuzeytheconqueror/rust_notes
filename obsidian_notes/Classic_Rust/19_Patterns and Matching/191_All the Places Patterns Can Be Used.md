...
[Listing 19-1](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-1): Using a pattern to destructure a tuple and create three variables at once
...
[Listing 19-2](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-2): Incorrectly constructing a pattern whose variables don’t match the number of elements in the tuple
...
[Listing 19-3](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-3): Mixing `if let`, `else if`, `else if let`, and `else`
...
[Listing 19-4](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-4): Using a `while let` loop to print values for as long as `rx.recv()` returns `Ok`
...
[Listing 19-5](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-5): Using a pattern in a `for` loop to destructure a tuple
...
[Listing 19-6](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-6): A function signature using patterns in the parameters
...
[Listing 19-7](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html#listing-19-7): A function with parameters that destructure a tuple
...
[ignoring-values-in-a-pattern]: https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#ignoring-values-in-a-pattern

---
> [!info] Source
> Nearly verbatim from [All the Places Patterns Can Be Used](https://doc.rust-lang.org/stable/book/ch19-01-all-the-places-for-patterns.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[190_Patterns and Matching|Patterns and Matching]] — previous section
> - [[192_Refutability - Whether a Pattern Might Fail to Match|Refutability: Whether a Pattern Might Fail to Match]] — next section

---
← [[190_Patterns and Matching|Patterns and Matching]] · [[README|⌂ Classic Rust Index]] · [[192_Refutability - Whether a Pattern Might Fail to Match|Refutability: Whether a Pattern Might Fail to Match]] →
