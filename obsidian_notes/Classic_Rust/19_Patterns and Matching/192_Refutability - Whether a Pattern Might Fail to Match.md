...
[Listing 19-8](https://doc.rust-lang.org/stable/book/ch19-02-refutability.html#listing-19-8): Attempting to use a refutable pattern with `let`
...
[Listing 19-9](https://doc.rust-lang.org/stable/book/ch19-02-refutability.html#listing-19-9): Using `let...else` and a block with refutable patterns instead of `let`
...
[Listing 19-10](https://doc.rust-lang.org/stable/book/ch19-02-refutability.html#listing-19-10): Attempting to use an irrefutable pattern with `let...else`
...
---
> [!info] Source
> Nearly verbatim from [Refutability: Whether a Pattern Might Fail to Match](https://doc.rust-lang.org/stable/book/ch19-02-refutability.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[190_Patterns and Matching|Patterns and Matching]] — chapter overview
> - [[191_All the Places Patterns Can Be Used|All the Places Patterns Can Be Used]] — previous section
> - [[193_Pattern Syntax|Pattern Syntax]] — next section

---
← [[191_All the Places Patterns Can Be Used|All the Places Patterns Can Be Used]] · [[README|⌂ Classic Rust Index]] · [[193_Pattern Syntax|Pattern Syntax]] →
