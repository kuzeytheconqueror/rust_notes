...
[Listing 19-11](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-11): A `match` expression with an arm that introduces a new variable which shadows an existing variable `y`
...
Guards”](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#adding-conditionals-with-match-guards) section.
...
[Listing 19-12](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-12): Destructuring a struct’s fields into separate variables
...
[Listing 19-13](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-13): Destructuring struct fields using struct field shorthand
...
[Listing 19-14](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-14): Destructuring and matching literal values in one pattern
...
[Listing 19-15](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-15): Destructuring enum variants that hold different kinds of values
...
[Listing 19-16](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-16): Matching on nested enums
...
[Listing 19-17](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-17): Using `_` in a function signature
...
[Listing 19-18](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-18): Using an underscore within patterns that match `Some` variants when we don’t need to use the value inside the `Some`
...
[Listing 19-19](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-19): Ignoring multiple parts of a tuple
...
[Listing 19-20](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-20): Starting a variable name with an underscore to avoid getting unused variable warnings
...
[Listing 19-21](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-21): An unused variable starting with an underscore still binds the value, which might take ownership of the value.
...
[Listing 19-22](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-22): Using an underscore does not bind the value.
...
[Listing 19-23](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-23): Ignoring all fields of a `Point` except for `x` by using `..`
...
[Listing 19-24](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-24): Matching only the first and last values in a tuple and ignoring all other values
...
[Listing 19-25](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-25): An attempt to use `..` in an ambiguous way
...
[Listing 19-26](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-26): Adding a match guard to a pattern
...
[Listing 19-27](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-27): Using a match guard to test for equality with an outer variable
...
[Listing 19-28](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-28): Combining multiple patterns with a match guard
...
[Listing 19-29](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html#listing-19-29): Using `@` to bind to a value in a pattern while also testing it
...
---
> [!info] Source
> Nearly verbatim from [Pattern Syntax](https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[190_Patterns and Matching|Patterns and Matching]] — chapter overview
> - [[192_Refutability - Whether a Pattern Might Fail to Match|Refutability: Whether a Pattern Might Fail to Match]] — previous section
> - [[200_Advanced Features|Advanced Features]] — next section

---
← [[192_Refutability - Whether a Pattern Might Fail to Match|Refutability: Whether a Pattern Might Fail to Match]] · [[README|⌂ Classic Rust Index]] · [[200_Advanced Features|Advanced Features]] →
