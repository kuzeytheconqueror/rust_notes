...
[Listing 20-13](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-13): The definition of the `Iterator` trait that has an associated type `Item`
...
[Listing 20-14](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-14): A hypothetical definition of the `Iterator` trait using generics
...
[Listing 20-15](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-15): Implementing the `Add` trait to overload the `+` operator for `Point` instances
...
[Listing 20-16](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-16): Implementing the `Add` trait on `Millimeters` to add `Millimeters` and `Meters`
...
[Listing 20-17](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-17): Two traits are defined to have a `fly` method and are implemented on the `Human` type, and a `fly` method is implemented on `Human` directly.
...
[Listing 20-18](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-18): Calling `fly` on an instance of `Human`
...
[Listing 20-19](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-19): Specifying which trait’s `fly` method we want to call
...
[Listing 20-20](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-20): A trait with an associated function and a type with an associated function of the same name that also implements the trait
...
[Listing 20-21](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-21): Attempting to call the `baby_name` function from the `Animal` trait, but Rust doesn’t know which implementation to use
...
[Listing 20-22](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-22): Using fully qualified syntax to specify that we want to call the `baby_name` function from the `Animal` trait as implemented on `Dog`
...
[Listing 20-23](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-23): Implementing the `OutlinePrint` trait that requires the functionality from `Display`
...
[Listing 20-24](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#listing-20-24): Creating a `Wrapper` type around `Vec<String>` to implement `Display`
...
[newtype]: https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#implementing-external-traits-with-the-newtype-pattern
[implementing-a-trait-on-a-type]: https://doc.rust-lang.org/stable/book/ch10-02-traits.html#implementing-a-trait-on-a-type
[traits]: https://doc.rust-lang.org/stable/book/ch10-02-traits.html
[smart-pointer-deref]: https://doc.rust-lang.org/stable/book/ch15-02-deref.html#treating-smart-pointers-like-regular-references
[tuple-structs]: https://doc.rust-lang.org/stable/book/ch05-01-defining-structs.html#creating-different-types-with-tuple-structs

---
> [!info] Source
> Nearly verbatim from [Advanced Traits](https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[200_Advanced Features|Advanced Features]] — chapter overview
> - [[201_Unsafe Rust|Unsafe Rust]] — previous section
> - [[203_Advanced Types|Advanced Types]] — next section

---
← [[201_Unsafe Rust|Unsafe Rust]] · [[README|⌂ Classic Rust Index]] · [[203_Advanced Types|Advanced Types]] →
