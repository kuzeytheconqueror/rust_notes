...
[Listing 20-28](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-28): Using the `fn` type to accept a function pointer as an argument
...
[Listing 20-29](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-29): Using a closure with the `map` method to convert numbers to strings
...
[Listing 20-30](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-30): Using the `String::to_string` function with the `map` method to convert numbers to strings
...
[Listing 20-31](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-31): Using an enum initializer with the `map` method to create a `Status` instance from numbers
...
[Listing 20-32](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-32): Returning a closure from a function using the `impl Trait` syntax
...
[Listing 20-33](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-33): Creating a `Vec<T>` of closures defined by functions that return `impl Fn` types
...
[Listing 20-34](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html#listing-20-34): Creating a `Vec<T>` of closures defined by functions that return `Box<dyn Fn>` so that they have the same type
...
[advanced-traits]: https://doc.rust-lang.org/stable/book/ch20-02-advanced-traits.html#advanced-traits
[enum-values]: https://doc.rust-lang.org/stable/book/ch06-01-defining-an-enum.html#enum-values
[closure-types]: https://doc.rust-lang.org/stable/book/ch13-01-closures.html#closure-type-inference-and-annotation
[future-types]: https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html
[trait-objects]: https://doc.rust-lang.org/stable/book/ch18-02-trait-objects.html

---
> [!info] Source
> Nearly verbatim from [Advanced Functions and Closures](https://doc.rust-lang.org/stable/book/ch20-04-advanced-functions-and-closures.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[200_Advanced Features|Advanced Features]] — chapter overview
> - [[203_Advanced Types|Advanced Types]] — previous section
> - [[205_Macros|Macros]] — next section

---
← [[203_Advanced Types|Advanced Types]] · [[README|⌂ Classic Rust Index]] · [[205_Macros|Macros]] →
