...
[Listing 20-35](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-35): A simplified version of the `vec!` macro definition
...
[Listing 20-36](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-36): An example of defining a procedural macro
...
[Listing 20-37](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-37): The code a user of our crate will be able to write when using our procedural macro
...
[Listing 20-38](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-38): A simple trait that we will use with the `derive` macro
...
[Listing 20-39](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-39): How it would look if users wrote a manual implementation of the `HelloMacro` trait
...
[Listing 20-40](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-40): Code that most procedural macro crates will require in order to process Rust code
...
[Listing 20-41](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-41): The `DeriveInput` instance we get when parsing the code that has the macro’s attribute in Listing 20-37
...
[Listing 20-42](https://doc.rust-lang.org/stable/book/ch20-05-macros.html#listing-20-42): Implementing the `HelloMacro` trait using the parsed Rust code
...
---
> [!info] Source
> Nearly verbatim from [Macros](https://doc.rust-lang.org/stable/book/ch20-05-macros.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[200_Advanced Features|Advanced Features]] — chapter overview
> - [[204_Advanced Functions and Closures|Advanced Functions and Closures]] — previous section
> - [[210_Final Project - Building a Multithreaded Web Server|Final Project: Building a Multithreaded Web Server]] — next section

---
← [[204_Advanced Functions and Closures|Advanced Functions and Closures]] · [[README|⌂ Classic Rust Index]] · [[210_Final Project - Building a Multithreaded Web Server|Final Project: Building a Multithreaded Web Server]] →
