...
[Listing 21-10](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-10): Simulating a slow request by sleeping for five seconds
...
[Listing 21-11](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-11): Spawning a new thread for each stream
...
[Listing 21-12](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-12): Our ideal `ThreadPool` interface
...
Threads”](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#creating-a-finite-number-of-threads) section that we
...
[Listing 21-13](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-13): Implementing `ThreadPool::new` to panic if `size` is zero
...
[Listing 21-14](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-14): Creating a vector for `ThreadPool` to hold the threads
...
[Listing 21-15](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-15): Modifying `ThreadPool` to hold `Worker` instances instead of holding threads directly
...
[Listing 21-16](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-16): Modifying `ThreadPool` to store the sender of a channel that transmits `Job` instances
...
[Listing 21-17](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-17): Passing the receiver to each `Worker`
...
[Listing 21-18](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-18): Sharing the receiver among the `Worker` instances using `Arc` and `Mutex`
...
[Listing 21-19](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-19): Creating a `Job` type alias for a `Box` that holds each closure and then sending the job down the channel
...
[Listing 21-20](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-20): Receiving and executing the jobs in the `Worker` instance’s thread
...
[Listing 21-21](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html#listing-21-21): An alternative implementation of `Worker::new` using `while let`
...
[type-aliases]: https://doc.rust-lang.org/stable/book/ch20-03-advanced-types.html#type-synonyms-and-type-aliases
[integer-types]: https://doc.rust-lang.org/stable/book/ch03-02-data-types.html#integer-types
[moving-out-of-closures]: https://doc.rust-lang.org/stable/book/ch13-01-closures.html#moving-captured-values-out-of-closures
[builder]: ../std/thread/struct.Builder.html
[builder-spawn]: ../std/thread/struct.Builder.html#method.spawn

---
> [!info] Source
> Nearly verbatim from [From Single-Threaded to Multithreaded Server](https://doc.rust-lang.org/stable/book/ch21-02-multithreaded.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[210_Final Project - Building a Multithreaded Web Server|Final Project: Building a Multithreaded Web Server]] — chapter overview
> - [[211_Building a Single-Threaded Web Server|Building a Single-Threaded Web Server]] — previous section
> - [[213_Graceful Shutdown and Cleanup|Graceful Shutdown and Cleanup]] — next section

---
← [[211_Building a Single-Threaded Web Server|Building a Single-Threaded Web Server]] · [[README|⌂ Classic Rust Index]] · [[213_Graceful Shutdown and Cleanup|Graceful Shutdown and Cleanup]] →
