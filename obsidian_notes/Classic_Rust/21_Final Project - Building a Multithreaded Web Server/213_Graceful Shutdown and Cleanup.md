...
[Listing 21-22](https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html#listing-21-22): Joining each thread when the thread pool goes out of scope
...
[Listing 21-23](https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html#listing-21-23): Explicitly dropping `sender` before joining the `Worker` threads
...
[Listing 21-24](https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html#listing-21-24): Explicitly breaking out of the loop when `recv` returns an error
...
[Listing 21-25](https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html#listing-21-25): Shutting down the server after serving two requests by exiting the loop
...
---
> [!info] Source
> Nearly verbatim from [Graceful Shutdown and Cleanup](https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[210_Final Project - Building a Multithreaded Web Server|Final Project: Building a Multithreaded Web Server]] — chapter overview
> - [[212_From Single-Threaded to Multithreaded Server|From Single-Threaded to Multithreaded Server]] — previous section
> - [[A00_Appendix|Appendix]] — next section

---
← [[212_From Single-Threaded to Multithreaded Server|From Single-Threaded to Multithreaded Server]] · [[README|⌂ Classic Rust Index]] · [[A00_Appendix|Appendix]] →
