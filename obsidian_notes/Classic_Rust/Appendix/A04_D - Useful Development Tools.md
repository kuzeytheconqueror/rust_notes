...
---
> [!info] Source
> Nearly verbatim from [D - Useful Development Tools](https://doc.rust-lang.org/stable/book/appendix-04-useful-development-tools.html) in *The Rust Programming Language*.

> [!tip] Related Notes
> - [[A00_Appendix|Appendix]] — chapter overview
> - [[A03_C - Derivable Traits|C - Derivable Traits]] — previous section
> - [[A05_E - Editions|E - Editions]] — next section

---
← [[A03_C - Derivable Traits|C - Derivable Traits]] · [[README|⌂ Classic Rust Index]] · [[A05_E - Editions|E - Editions]] →
